========================================================================
    ACTIVE TEMPLATE LIBRARY : Sensor Project Overview
========================================================================

AppWizard has created this Sensor project for you to use as the starting point for
...
Sensor.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (Sensor.h)
        GUID definitions                                (Sensor_i.c)
        A type library                                  (Sensor.tlb)
        Marshaling code                                 (Sensor_p.c and dlldata.c)

Sensor.h
    This file contains the C++ interface definitions and GUID declarations of the
    items defined in Sensor.idl. It will be regenerated by MIDL during compilation.
...
StdAfx.h, StdAfx.cpp
    ...
    named Sensor.pch and a precompiled types file named StdAfx.obj.
...
Sensorps.vcxproj
	...
	dlldata.c, Sensor_i.c and Sensor_p.c which are required
	to build the proxy/stub DLL.

Sensorps.vcxproj.filters
